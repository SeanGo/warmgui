#ifndef __days_ctpmmd_graph__
#define __days_ctpmmd_graph__

class CDaysCtpmmdGraph : public WARMGUI::IDataGraph_summer
{
public:
    CDaysCtpmmdGraph(const char* name);
    ~CDaysCtpmmdGraph(void);
...
private:
    ...
    void SetClass() { SetMyClass("CDaysCtpmmdGraph"); }
};

#endif //__days_ctpmmd_graph__